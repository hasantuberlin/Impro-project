'''
helps to convert raw data into desired json file. it will create one json file with all data(clinical and waveform) of a patient.  
'''
...
'''
input: input file path and dict where we will save our data. 
output clinicalDataDict. which contains clinical data. each object in the dict is a source. 
which contains list where each value is a new value. 
'''
...
def main():
	...
	patient= dict()
	patient['subID']= 's05126'
	patient['sex']= 'm'
	patient['age']= 43
	patient['dateOfBirth']= '13/04/19788'
